...
uint8_t si5351_write_bulk(uint8_t regAddr, uint8_t length, uint8_t *data) {
  ...
  i2c_write_blocking(i2c1, i2c_bus_addr, msg, (length + 1), false);
...
uint8_t si5351_read(uint8_t regAddr) {
  ...
  i2c_write_blocking(i2c1, i2c_bus_addr, &regAddr, 1, true);
  i2c_read_blocking(i2c1, i2c_bus_addr, &buf, 1, false);
