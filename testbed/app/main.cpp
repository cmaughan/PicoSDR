...
#define APP_UNLIMITED_FRAME_RATE
#ifdef _DEBUG
...
int main(int, char**)
{
    ...
    Zest::runtree_init(SDL_GetBasePath(), TESTBED_ROOT);
    ...
    io.Fonts->AddFontFromFileTTF((fs::path(TESTBED_ROOT) / "run_tree" / "fonts" / "cousine-regular.ttf").string().c_str(), 32.0f);
